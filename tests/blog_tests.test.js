...
describe('total likes', () => {
    ...
    test('when list contains many blogs, the total like count is sum of every blogs likes', () => {
        const res = listHelper.totalLikes(manyBlogs)
        expect(res).toBe(36) 
    })

    test('when the list is empty the result should be 0', () => {
...
describe('favorite blog', () => {
    ...
    test('when list has many blogs the favorite is the one with the most likes', () => {
        ...
        expect(res).toEqual(manyBlogs[2])
    })
